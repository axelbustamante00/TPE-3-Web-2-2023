...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2023 a las 14:27:01
...
INSERT INTO `albums` (`id_album`, `album_name`, `release_date`, `id_artist`, `duration`, `selected`) VALUES
...
--
ALTER TABLE `albums`
  ADD CONSTRAINT `albums_ibfk_1` FOREIGN KEY (`id_artist`) REFERENCES `artistas` (`id_artist`);
COMMIT;
